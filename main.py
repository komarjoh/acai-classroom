...
while video.isOpened():
    ...
    temp_coord_df.to_csv("reportsourcefile_landmarkcoordinates.csv", index=False)
...
df.to_csv("reportsourcefile_center_of_gravity.csv", index=False)
...
teaching_style_df.to_csv("teachingstyle_output.csv", index=False)